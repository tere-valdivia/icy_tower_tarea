...
class Figura(object):
    def __init__(self, pos, rgb=(1.0, 1.0, 1.0)):
        self.pos = pos
        self.color = rgb
        self.lista = 0
        self.crear()
    ...
    def dibujar(self):
        ...
        self.crear() #Puesto para que se dibujen de 0 las figuras siempre
        #Ver como optimizar luego porque puede ser muy pesado
